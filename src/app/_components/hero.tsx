...
<div className="flex flex-col gap-3">
        ...
        <p className="text-base">
          ...
          entrepreneur based in Texas. Currently I&apos;m a student working through university while founding GreekPoints and probably 3 other side projects. I&apos;m known for nitpicking UIs and automating everything to make lives easier.
        </p>
