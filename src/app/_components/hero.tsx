...
<div className="flex flex-col gap-4">
        ...
        <div className="flex flex-row gap-3">
          ...
          <Link className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 p-1 rounded-lg text-black dark:text-white" target="_blank" href="https://www.linkedin.com/in/ian-hildebrand/">
            <FaLinkedin className="w-6 h-6" />
          </Link>
          <Link className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 p-1 rounded-lg text-black dark:text-white" target="_blank" href="https://x.com/ianhildy">
