...
const sideProjects = [
  {
    name: "Homelab Server",
    description:
      "2x Dell R710s hosting all my side projects, dev environments, backups, and more.",
    techStack: [
      "Ubuntu Server",
      "Docker",
      "Nginx",
  ...
  },
  {
    ...
    description:
      "An overengineered, task queue for Google Jules power users (AI async coding agent).",
    techStack: [
      "Next.js",
      "Tailwind CSS",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "A CLI tool to make working with Google Jules easier with Linear and Github - published on npm.",
  ...
  },
  {
    ...
    description:
      "Android emulator + REST API for automating the Chirp Access app for home automation.",
  ...
  },
  {
    ...
    description:
      "An opinionated version of create-next-app with all my tools and AI rules setup.",
  ...
  },
  {
    ...
    description:
      "A dashboard for members to setup, modify, defer, and pay for their dues asynchronously. Including reverse engineering GreekBill to create a sync engine.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Prisma",
  ...
  },
  {
    ...
    description:
      "Providing event notifications, chapter bank managment, member and server managment, with a payment platform integration for bill reminders.",
    techStack: [
      "Node.js",
      "TypeScript",
      "Discord.js",
